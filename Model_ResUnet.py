...
def Model_ResUnet(Unet_Path, Image_Path, Mask_Path, Predict_Path,
                    model_name='UNet3Plus.h5', nput_size=(256, 256, 1), **model_kwargs):
    data_gen_args = dict(rotation_range=0.2,
                         ...
                         fill_mode='nearest')
    model = res_unet(input_size=(512, 512, 3), **model_kwargs)
    model.summary()
